...
function stringy(string) {
    ...
    string = string.replaceAll(/[\x00-\x1F\x7F-\xFF]/g, match => (alert(match) || cabbrev[match.charCodeAt(0)] ? `\\${cabbrev[match.charCodeAt(0)]}` : `\\x${match.charCodeAt(0).toString(16).padStart(2, '0')}`));

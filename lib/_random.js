...
module.words.add('random.01', function r() { this.push(bob()); });
module.words.add('random.getstate', function g() { this.push(bobstate); });
module.words.add('random.setstate', function s() { this.expect('array'); bobstate = this.pop(); });
module.words.add('random.seed', function ss() { this.expect('number'); bobseed(this.pop()); });
...
module.words.add('random.xmur', function x() { this.expect('string'); this.push(xmur3(this.pop())); });
